...
- [x] avatar presence (`.re-avatar__presence` corner status dot; `data-presence` online/away/busy/offline, filled/hollow/bar shape split; extends `avatar.css`) — 1.13.0
